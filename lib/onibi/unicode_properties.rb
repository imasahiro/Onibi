...
module Onibi
  ...
  module UnicodeProperties
    ...
    SUPPORTED = %w[
      ASCII Any Emoji Emoji_Presentation Han Hiragana Katakana Latin Greek Cyrillic Arabic
    ...
    PROPERTY_MATCHERS = {
      "ASCII" => :ascii?, "Any" => :any?, "Emoji" => :emoji?, "Emoji_Presentation" => :emoji_presentation?, "Han" => :han?, "Hiragana" => :hiragana?,
