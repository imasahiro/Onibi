...
variable payloads. Sequence child links now use C records during parsing and
are materialized only in the AST adapter. Character-class ranges use C records
