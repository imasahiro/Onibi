...
### HFA-000 - Publish the canonical HFA design

- **Priority:** P0
- **Dependencies:** none
- **Change type:** documentation only

Create `docs/hfa-design.md` as the canonical architecture document. It must
...
Update the canonical design overview, CFG pipeline, README, and development
guide so they point to this design. Mark the existing hybrid-backend and
Hyperscan documents as historical PoC reports. Remove all references to missing
generated-Ruby design files and all claims that production does not execute an
NFA or DFA.
...
### HFA-042 - Lower nonregular constructs to typed semantic components
