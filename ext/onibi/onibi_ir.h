...
#define ONIBI_RAP_BEGIN_BUFFER UINT16_C(1)
#define ONIBI_RAP_END_BUFFER UINT16_C(2)
#define ONIBI_RAP_BEGIN_LINE UINT16_C(3)
#define ONIBI_RAP_END_LINE UINT16_C(4)
#define ONIBI_RAP_SEMI_END_BUFFER UINT16_C(5)
#define ONIBI_RAP_SEARCH_ORIGIN UINT16_C(6)
#define ONIBI_RAP_WORD_BOUNDARY UINT16_C(7)
#define ONIBI_RAP_NONWORD_BOUNDARY UINT16_C(8)
#define ONIBI_RAP_LOOKAHEAD UINT16_C(9)
#define ONIBI_RAP_LOOKBEHIND UINT16_C(10)
